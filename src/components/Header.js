  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        iconContent={<Icon size={16} color={theme.COLORS.MUTED} name="search-plus" family="font-awesome" />}
      />
    );
  }
  renderOptions = () => {
    ...
    return (
      <Block row style={styles.options}>
        <Button shadowless style={[styles.tab, styles.divider]} onPress={() => navigation.navigate('Pro')}>
          <Block row middle>
            <Icon name="diamond" family="font-awesome" style={{ paddingRight: 8 }} color={theme.COLORS.ICON} />
            <Text size={16} style={styles.tabTitle}>{optionLeft || 'Beauty'}</Text>
          </Block>
        </Button>
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Pro')}>
          <Block row middle>
            <Icon size={16} name="shopping-bag" family="entypo" style={{ paddingRight: 8 }} color={theme.COLORS.ICON}/>
